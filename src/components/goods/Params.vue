<template>
    <div>
                    ...
                    <el-table :data="manyTableData" border stripe>
                        ...
                        <el-table-column type="expand">
                            <template slot-scope="scope">
                                <!-- 循环渲染tag标签 -->
                                    <el-tag v-for="(item, i) in scope.row.attr_vals" :key="i" closable @click="handleClose(i,scope.row)">
                                        {{item}}
                                    </el-tag>
                                    <!-- 输入的文本框 -->
        ...
        <!-- 添加参数的对话框 -->
        <el-dialog :title="'添加'+titleText" :visible.sync ='addDialogVisible' width="50%" @click="addDialogClosed" >
            <!-- 添加参数的对话框 -->
        ...
        <!-- 添加参数的对话框 -->
        <el-dialog :title="'添加'+titleText" :visible.sync ='editDialogVisible' width="50%" @click="editDialogClosed" >
            <!-- 添加参数的对话框 -->
